...
* FEATURE: `@ExtensionMethod` now supports 'default' extensions using [config key](https://projectlombok.org/features/configuration) `lombok.extensionMethod.defaultExtensions`.
